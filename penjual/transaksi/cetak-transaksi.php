  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center">
        <h3>DATA ORDERAN WELDING SHOP</h3>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12 text-center ">
        <table class="table" style="margin-top: 100px">
          ...
          <tbody>
            ...
            include '../../rupiah.php';
            $no = 1;
            $my = mysqli_query($koneksi, "SELECT * FROM transaksi JOIN produk ON transaksi.id_produk=produk.id_produk JOIN penjual ON produk.id_penjual=penjual.id_penjual JOIN pembeli ON transaksi.id_pembeli=pembeli.id_pembeli WHERE produk.id_penjual='$_GET[id_penjual]'");
