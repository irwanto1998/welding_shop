...
if (isset($_POST['masuk'])) {
  ...
  $log =  mysqli_query($koneksi, "SELECT * FROM pembeli WHERE email_pembeli='$email_pembeli' AND password_pembeli='$password_pembeli'");
  ...
  if(mysqli_num_rows($log) == 1){
    ...
    echo "<meta http-equiv='refresh' content='0; url=../pembeli/app.php'></script>";
    } else{
    ...
    <div class="container ">
       <div class="row-clearfix p-b-125">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="header">
                    <h3 class="font-bold font-20 text-center col-green">Masuk Sekarang</h3>
                    <span class="font-14 m-t-20">
                        Belum punya akun WELDING SHOP, <a href="daftar.php" class="font-bold">Daftar</a>
                    </span>
                </div>
                <div class="body">
                    ...
                    <button type="submit" name="masuk" class="btn bg-green btn-block btn-lg font-bold">MASUK</button>
                    <br>
