...
<section class="page-login bg-green p-t-125">
    
    <div class="container ">
       <div class="row-clearfix p-b-125">
        <div class="col-md-8">
            <img src="../assets/images/w1.jpg" alt="" width="100%" height="400">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="header">
                    <h3 class="font-bold font-20 text-center col-green">Daftar Sekarang</h3>
                    <span class="font-14 m-t-20">
                        Sudah punya akun WELDING SHOP, <a href="masuk.php" class="font-bold">Masuk</a>
                    </span>
                </div>
                <div class="body">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="number" name="tlp_pembeli" class="form-control" placeholder="No Telepon ..." required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
                            <input type="email" name="email_pembeli" class="form-control" placeholder="Email ..." required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
                            <input type="password" name="password_pembeli" minlength="5" class="form-control" placeholder="Password ..." required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" name="alamat_pembeli" minlength="5" class="form-control" placeholder="Alamat ..." required="">
                        </div>
                    </div>


                    <button type="submit" name="daftar" class="btn bg-green btn-block btn-lg font-bold">DAFTAR</button>
                    <br>
                    <a href="masuk.php"><b>Kembali</b></a>
                </form>
                </div>
            </div>
        </div>
...
<div class="paralax m-t-20">
    <div class="paralax-images">
        <h2 class="font-bold font-20 text-center col-green">
...
$simpanData = mysqli_query($koneksi, "INSERT INTO pembeli VALUES(NULL,'$nama_pembeli','$tlp_pembeli','$alamat_pembeli','$email_pembeli','$password_pembeli','');");
  ...
  if ($simpanData) {
    ...
    echo "<meta http-equiv='refresh' content='0; url=masuk.php></script>";
  }else{
    echo "<script>alert('Terjadi kesalahan, coba ulangi kembali')</script>";
    echo "<meta http-equiv='refresh' content='0; url=daftar.php'></script>";
  }
