...
$query = "SELECT * FROM komentar WHERE nama_produk='$_GET[nama_produk]' AND id_pembeli='$_GET[id_pembeli]'  AND hapus_drpembeli='Y' AND parent_komentar_id  = '0' ORDER BY komentar_id DESC";
