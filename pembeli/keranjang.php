                 ...
                 <tr>
                  ...
                  <td>
                    <center>
                      ...
                      <input type="hidden" name="no_rek_penjual[]" value="<?php echo $d['no_rek_penjual'] ?>">
            ...
            <div class="col-md-6">
              <table class="table">
                ...
                <tr>
                  ...
                  <td>:</td>
                  <td>
                    <input type="hidden" class="form-control" name="id_pembeli" value="<?php echo $ids ?>">
                    <?php echo $namas ?>
                  </td>
                </tr> 
              </table>
...
for ($i=0; $i < $dipilih; $i++) { 
  $simpanCheckout = mysqli_query($koneksi, "INSERT INTO transaksi  VALUES('','$kode_keranjang','$id_pembeli','$id_produk[$i]','$banyak[$i]','$harga[$i]','$tgl_transaksi','Menunggu konfirmasi','$no_rek_penjual[$i]','Belum Bayar','','');");
}

   if ($simpanCheckout) { 
  mysqli_query($koneksi, "DELETE FROM keranjang WHERE kode_keranjang='$kode_keranjang'");
          echo "<meta http-equiv='refresh' content='0; url=?page=pesan-sukses&kode=$kode_keranjang'></script>";
        }else{
