...
<li class="footer">
    <a href="?page=keranjang">Lihat Keranjang</a>
</li>
</ul>
                   <?php } ?>
                </li>
...
<li class="footer">
    <a href="?page=produk/index1">Lihat Chat</a>
</li>
</ul>
                   <?php } ?>
                </li>
 ...
 <script>
    $(document).ready(function(){
      ...
      function load_comment(){
        $.ajax({
          url:"ambil_komentar.php?nama_produk=<?php echo $data_s['nama_produk']; ?>",
          method:"POST",
          success:function(data){
